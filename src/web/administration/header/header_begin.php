...
<html>
  <head>
	...
	<link rel="stylesheet" href="/administration/header/css/header.css">
	...
	<script src="/administration/header/js/header.js"></script>
	  	...
	  	<div class="container">
			  ...
			  <div class="container-fluid">
			    ...
			    <div class="navbar-header">
			      ...
			      <a class="navbar-brand" href="" onclick="navigateHome()"><img id="logo" class="img-responsive" alt="Home" src="/administration/pics/home.png"></a>
			    </div>
